        ...
        public async Task EnsureSeedDataAsync()
        {
            ...
            if (!_context.Trips.Any())
            {
                ...
                var usTrip = new Trip()
                {
                    ...
                    Stops = new List<Stop>()
                    {
                        new Stop() { Name = "Atlanta, GA", Arrival = DateTime.Parse("Jun 4, 2014"), Latitude = 33.748995, Longitude = -84.387982, Order = 0 },
                        new Stop() { Name = "New York, NY", Arrival = DateTime.Parse("Jun 9, 2014"), Latitude = 40.712784, Longitude = -74.005941, Order = 1 },
                        new Stop() { Name = "Boston, MA", Arrival = DateTime.Parse("Jul 1, 2014"), Latitude = 42.360082, Longitude = -71.058880, Order = 2 },
                        new Stop() { Name = "Chicago, IL", Arrival = DateTime.Parse("Jul 10, 2014"), Latitude = 41.878114, Longitude = -87.629798, Order = 3 },
                        new Stop() { Name = "Seattle, WA", Arrival = DateTime.Parse("Aug 13, 2014"), Latitude = 47.606209, Longitude = -122.332071, Order = 4 },
                        new Stop() { Name = "Atlanta, GA", Arrival = DateTime.Parse("Aug 24, 2014"), Latitude = 33.748995, Longitude = -84.387982, Order = 5 },
                    }
                };
